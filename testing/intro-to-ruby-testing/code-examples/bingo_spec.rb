...
#intializes 'letters' attribut equal to an array of letters bingo
assert_equal(bingo.letters,["B","I","N","G","O"])

#initializes 'finished' attribut to false
...
# Bingo#mark!(ticket)
  ...
  # when given a ticket with a value existing on the board, replaces value with "X"
    ticket = {letter:"G", number:65}
    bingo.mark!(ticket)
    assert_equal(bingo.board[1][3],"X")
